...
Процедура ДобавитьЭлементыВТабличнуюЧасть(МассивЭлементов)
	...
	Для каждого ЭлементМассива Из МассивЭлементов Цикл
		...
		Если Объект.Номенклатура.НайтиСтроки(Новый Структура("Ссылка", ЭлементМассива)).Количество() > 0 Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("МассивНоменклатуры") Тогда
		...
		Для каждого ЭлементаМассива Из Параметры.МассивНоменклатуры Цикл
...
Процедура ОК(Команда)
	...
	ОповеститьОВыборе(ЗаполнитьМассивПоТаблицнойЧастиНаКлиенте("Номенклатура"));
...
Процедура Подбор(Команда)
	...
	ОткрытьФорму("Справочник.Номенклатура.ФормаВыбора", Новый Структура("МножественныйВыбор, ВыборГруппИЭлементов, РежимВыбора, ЗакрыватьПриВыборе", Истина, ИспользованиеГруппИЭлементов.ГруппыИЭлементы, Истина, Ложь), ЭтаФорма);
